...
完整能力清单见：[功能总览（中文）](docs/zh/api-editor-core.md) / [EditorCore API (EN)](docs/en/api-editor-core.md)
...
| [EditorCore API（中文）](docs/zh/api-editor-core.md) / [EditorCore API (EN)](docs/en/api-editor-core.md) | C++ 核心层和 C API 参考                              |
| [平台 API 索引（中文）](docs/zh/api-platform.md) / [Platform API Index (EN)](docs/en/api-platform.md)        | Android / Swing / Apple / WinForms 平台 API 文档入口 |
